...
| Field | Value |
|---|---|
| Package status | `1.0.2_stable` -- reusable stable package, not L5 archival/publication-ready. |
...
This repository uses a controlled status progression: `0.1.0_public_draft`, `1.0.0-rc.N`, and `1.0.x_stable`. The current release is prepared as the stable v1.0.2 framework with L4 reusable-stable package conformance.

L5 archival/publication-ready status is not claimed for v1.0.2. L5 requires a separate release decision with completed preservation closure, registry publication, independent external review, archival fixity evidence, and L5 release approval.
